...
def register_handlers_prmd_animals(dp: Dispatcher):
    dp.register_callback_query_handler(clean, state=Profile.d_m_animals, text='clean')
    dp.register_callback_query_handler(back, state=Profile.d_m_animals, text='back')
    dp.register_message_handler(valid, state=Profile.d_m_animals)
